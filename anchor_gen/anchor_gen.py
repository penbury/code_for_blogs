...
featureMap_size = (5, 5) # feature map的大小
ratios = [0.5, 1, 2] # anchor的宽高比
scales = [0.5, 1, 2] # anchors的边长比
base_size = 2  # 感知野的大小=base_size * base_size
base_anchors = generate_anchors(base_size, ratios, scales) # (0,0)坐标点对应的anchors
print(base_anchors)
